...
for (i = 1; i<=z; i++ ){
    ...
    k = array.push(k);}
console.log("Console.log del 3° snecchino")
console.log(array)
console.log("------")
...
let zSnack4_1 =  Math.floor (Math.random( ) * 10 + 10 )
 ...
 for (i = 1; i <= zSnack4_1; i++ ){
    ...
    kSnack4 = array1Snack4.push(kSnack4);}
                    console.log("1° array random del 4° snecchino")                  
...
for (i = 1; i <= zSnack4_2; i++ ){
    ...
    kSnack4 = array2Snack4.push(kSnack4);}
                      console.log("2° array random del 4° snecchino")
...
if (difArray == 0){
        ...
        document.getElementById("aggiunti").innerHTML = `Aggiunti ${difArray} ora il secondo array è di ${array2Snack4.length} uguale al primo`;}
                          ...
                          console.log("------")
                          console.log("1° array del 4° snecchino dopo il ciclo if di controllo")
                          console.log(array1Snack4)
                          console.log("2° array del 4° snecchino dopo il ciclo if di controllo")
                          console.log(array2Snack4)
// !SECTION